...
class Sku extends \Eloquent {
	protected $fillable = ['sku_code', 'sku_desc', 'division_code' ,'division_desc', 'category_code',
	'category_desc', 'brand_code', 'brand_desc', 'cpg_code', 'cpg_desc', 'packsize_code','packsize_desc'];
